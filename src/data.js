...
const upcomingEvents = [
  {
    ...
    name: 'Coding Interview #5',
    day: 'Tue',
    date: 'Feb. 16',
    time: '6 pm - 8 pm PT',
    location: 'Zoom',
    description: 'Recursion and DP',
    facebook: 'https://fb.me/e/3MWBNmwOv',
    discord: 'https://discord.com/channels/702801010426511373/713559003661336607',
  },
  {
    image: '/static/event/upcoming/graph.png',
    name: 'Advanced Training #11',
    day: 'Thu',
    date: 'Feb. 18',
    time: '6:30 pm - 9:30 pm PT',
    location: 'Zoom',
    description: 'TBA',
    facebook: 'https://fb.me/e/1dqBzpvs5',
  ...
  },
  {
    ...
    location: 'Zoom',
    description: 'Trees',
    facebook: 'https://fb.me/e/6agcAeRKY',
