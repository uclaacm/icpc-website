...
const members = [
  ...
  },
  {
    ...
    name: 'Suhas Nagar',
    position: 'Advisor, President Emeritus',
    description: 'Hi! I\'m Suhas, a 3rd year CS Major from the Bay Area. In my free time, you can usually find me playing video games (I\'m a big fan of Hollow Knight + Outer Wilds), trying to write my own rap battles, or playing basketball at Wooden :)',
    funFacts: {
      'ice cream': 'Pink Rose',
      professor: 'Reinman',
      editor: 'IntelliJ',
  ...
  },
  {
    ...
    name: 'Illia Shkirko',
    position: 'Officer',
    description: 'Hi! I am a third year Computer Science major. I enjoy rock-climbing, traveling, skiing, and going to concerts.',
    funFacts: {
      'ice cream': 'Chocolate',
      professor: 'Nachenberg',
      editor: 'VSCode',
  ...
  },
  {
    ...
    name: 'Jason Huang',
    position: 'Officer',
    description: 'Hi! I\'m a rising 3rd year interested in math and cs. I like playing tennis and learning new songs on the piano in my free time. Hoping to get good at running xor swimming :)',
    funFacts: {
  ...
  },
  {
    ...
    name: 'Peony Mong',
    position: 'Officer',
    description: 'Hi, I\'m Peony, a second-year Computer Science major who is also trying to major in applied math. I like to do logic puzzles, play video games, do wushu, and spend quality time with my friends.',
    funFacts: {
  ...
  },
  {
    ...
    position: 'Officer',
    description: 'Hi, my name is Shreyas, and I\'m a second year EE major at UCLA. In my free time, I like to play basketball, play the guitar and piano, and go out with friends.',
    funFacts: {
      'ice cream': 'cotton candy',
