...
const EventCard = (props) => {
  ...
  const EventTimeAndLocation = (p) => {
    if (props.event.location === undefined)
      return ""
    return (
    ...
    return (
      <Flex align="baseline" justify="start" mt={2}>
        <Text
          ...
          align='left'
        >
          {props.event.quarter} <br/> {props.event.shortDesc}
        </Text>
      </Flex>
    );
  };
          ...
          <Modal isOpen={isOpen} onClose={onClose} isCentered scrollBehavior='inside'>
            ...
            <ModalContent>
              ...
              <ModalBody mt={"0px"} mb={'10px'}>
                ...
                {/* <EventLinks /> */}
                <EventTermAndShortDesc fontWeight="bold" />
                <Text>{props.event.description}</Text>
              </ModalBody>
            </ModalContent>
          </Modal>
...
export {EventCard, EventDescriptionCard};
