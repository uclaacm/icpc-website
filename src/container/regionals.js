      ...
      <Container narrow>
        ...
        <Stack pb={10} spacing={10}>
          ...
          <Stack align="center">
            ...
            <Text>The International Collegiate Programming Contest (ICPC) is an algorithmic programming contest for college students. Teams of three, representing their university, work to solve the most real-world problems, fostering collaboration, creativity, innovation, and the ability to perform under pressure. Through training and competition, teams challenge each other to raise the bar on the possible. Quite simply, it is the oldest, largest, and most prestigious programming contest in the world. It is often considered to be the ”Olympics of Programming Competitions”, featuring contestants from over 2,000 universities that are spread across 80 countries and six continents.
            </Text>
            <Text>
              ...
              <Accordion>
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4}>
                    ...
                    It is also worth mentioning that this tryout process is completely different from the application to join us as an officer! You need not be an expert at competitive programming to join us. All you need is a passion for teaching and problem-solving!</AccordionPanel>
                </AccordionItem>
                <AccordionItem>
                  <AccordionHeader>
                    <Box flex="1" textAlign="left">
